...
pub unsafe extern "C" fn init_num_node(mut value: value_t) -> *mut node_t {
    let mut node: *mut num_node_t =
        malloc(::std::mem::size_of::<num_node_t>() as libc::c_ulong) as *mut num_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 31], &[libc::c_char; 31]>(
                b"node_t *init_num_node(value_t)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn init_binary_node(
    mut op: libc::c_char,
    mut left: *mut node_t,
    ...
    let mut node: *mut binary_node_t =
        malloc(::std::mem::size_of::<binary_node_t>() as libc::c_ulong) as *mut binary_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<&[u8; 51], &[libc::c_char; 51]>(
                b"node_t *init_binary_node(char, node_t *, node_t *)\x00",
            ))
            .as_ptr(),
        );
    }
...
pub unsafe extern "C" fn init_var_node(mut name: var_name_t) -> *mut node_t {
    ...
    let mut node: *mut var_node_t =
        malloc(::std::mem::size_of::<var_node_t>() as libc::c_ulong) as *mut var_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn init_sequence_node(
    mut statement_count: size_t,
    mut statements: *mut *mut node_t,
) -> *mut node_t {
    if statements.is_null() && statement_count > 0 as libc::c_int as libc::c_ulong {
        return 0 as *mut node_t;
    }
    let mut node: *mut sequence_node_t =
        malloc(::std::mem::size_of::<sequence_node_t>() as libc::c_ulong) as *mut sequence_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<&[u8; 46], &[libc::c_char; 46]>(
                b"node_t *init_sequence_node(size_t, node_t **)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn init_print_node(mut expr: *mut node_t) -> *mut node_t {
    if expr.is_null() {
        return 0 as *mut node_t;
    }
    let mut node: *mut print_node_t =
        malloc(::std::mem::size_of::<print_node_t>() as libc::c_ulong) as *mut print_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<&[u8; 34], &[libc::c_char; 34]>(
                b"node_t *init_print_node(node_t *)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn init_let_node(mut var: var_name_t, mut value: *mut node_t) -> *mut node_t {
    if var as libc::c_int == '\u{0}' as i32 || value.is_null() {
        free_ast(value);
        return 0 as *mut node_t;
    }
    let mut node: *mut let_node_t =
        malloc(::std::mem::size_of::<let_node_t>() as libc::c_ulong) as *mut let_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<&[u8; 44], &[libc::c_char; 44]>(
                b"node_t *init_let_node(var_name_t, node_t *)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn init_if_node(
    mut condition: *mut binary_node_t,
    ...
    let mut node: *mut if_node_t =
        malloc(::std::mem::size_of::<if_node_t>() as libc::c_ulong) as *mut if_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<&[u8; 58], &[libc::c_char; 58]>(
                b"node_t *init_if_node(binary_node_t *, node_t *, node_t *)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn init_while_node(
    mut condition: *mut binary_node_t,
    mut body: *mut node_t,
) -> *mut node_t {
    ...
    let mut node: *mut while_node_t =
        malloc(::std::mem::size_of::<while_node_t>() as libc::c_ulong) as *mut while_node_t;
    if !node.is_null() {
    } else {
        __assert_fail(
            b"node != NULL\x00" as *const u8 as *const libc::c_char,
            ...
            (*::std::mem::transmute::<&[u8; 51], &[libc::c_char; 51]>(
                b"node_t *init_while_node(binary_node_t *, node_t *)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn print_ast_indented(mut node: *mut node_t, mut indent: size_t) {
